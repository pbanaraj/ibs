  ...
  <div class="container">
    <div id="wrapper">
      ...
      <div class="row">
        ...
        <?php endif;?>
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="custServiceWrapper">
            <div class="custServiceFirstContainer pageWrapper">
              <?php if (!empty($breadcrumb)): print $breadcrumb; endif;?>
              <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ralewayBold pageHeadng">
                ...
                <?php if (!empty($page['content_search'])): ?>
                  <?php print render($page['content_search']); ?>
                <?php endif; ?>
              </div>
              <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="custServiceSecondContainer pageWrapper" id="quickaccess">
              <?php print render($page['content']); ?>
            </div>
            <div class="custServiceThirdContainer pageWrapper" id="demo">
              <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
