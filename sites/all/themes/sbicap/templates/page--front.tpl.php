    ...
    <div class="wrapper indexwrapper">
        ...
        <header>
            <div class="row main-row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 searchSecMain">
                    ...
                    <div class="branchesWrapper pageWrapper <?php print 'Wrapper-'.end($aliases);//print variable_get('wrapper');//print $_SESSION['wrapper'];?>">
						  ...
						  <div class="row">
							...
							<?php if (!empty($page['sidebar_second'])): ?>
						      <aside class="col-md-3 col-sm-4 rightPanelAlign" role="complementary">
						    ...
						    <section class="col-md-9 col-sm-8">
							  ...
							  <div class="homepage-second-container">
								<div class="row">
									<div class="col-lg-6 col-md-6 demo-section">
									...
									<div class="col-lg-6 col-md-6 whats-new-section">
										<div class="inner-demo last-demo-cont">
