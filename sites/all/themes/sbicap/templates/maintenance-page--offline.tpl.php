<!DOCTYPE html>
<head>
  <title>Site off-line | SBI Smart</title>
  <style type="text/css">
    ...
    <div class="container">
		<div id="main">
	         <div id="content">
	             <div class="trade">
	               	  <h1>Oops!</h1>
	                  <p>SBI Smart Home Page is currently unavailable due to technical issues. We will be back shortly.
	                        Thank you for your patience. <br><br>
	                  <span class="click">Please <a href="https://trade.sbicapsec.com">click here</a> to go to Trade Login Page.</span></p>
	             </div>
	         </div>
		</div>
    </div>
