            ...
            <div id="wrapper">
				...
				<div class="page-content-area">
					<div class="row">
						...
						<div class="pageWrapper <?php print 'Wrapper-'.end($aliases);?>">
							  ...
							  <div class="row">
								<?php if (!empty($tabs)): ?>
								  ...
								  <?php endif; ?>
								   <div class="col-lg-11 col-md-11 col-sm-11 col-xs-10"><?php if (!empty($breadcrumb)): print $breadcrumb; endif;?></div>
